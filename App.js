...
//weather
  ...
  async function  GetWeatherData(){
    ...
    const data = await axios.get("https://weatherapi-com.p.rapidapi.com/forecast.json",{params:{q: place, days: '3'},
    headers: {
          'X-RapidAPI-Key': 'fa3fb6e83bmshc5f47411cdd4e0ep17307djsn85786301bafe',
  ...
  return (
    ...
    <div className="App">
      ...
      <div class='sidebar'><div className='inputdiv'>
          <input placeholder='Enter location' className='input' type="text" value={place} onChange={(e)=>{setPlace(e.target.value)}}/>
          <button className='button' onClick={GetWeatherData} >Enter</button>
        </div>
        ...
        <div className='headerbackg'>
          <h2 className='headername'>Leeon Israel <br/>the.weather</h2>
        </div>
        ...
        <div className='tempdiv'>
          ...
          <p className='place'> {location}, {locationregion}  <br/> {date} </p>
        </div>
